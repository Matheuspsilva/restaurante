...
Route::group(['middleware' => ['auth']], function(){
    ...
    Route::prefix('admin')->namespace('Admin')->group(function(){
        ...
        Route::prefix('restaurants')->group(function(){
            Route::get('','RestaurantController@index')->name('restaurant.index');//name = apelido da rota
        ...
        Route::prefix('users')->group(function(){
            Route::get('','UserController@index')->name('user.index');//name = apelido da rota
        ...
        Route::prefix('menus')->group(function(){
            Route::get('','MenuController@index')->name('menu.index');//name = apelido da rota
